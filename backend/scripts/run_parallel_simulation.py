...
from clinical_critic import filter_actions_with_critic
...
def create_model(config: Dict[str, Any], use_boost: bool = False):
    ...
    return ModelFactory.create(
        ...
        model_config_dict={"temperature": 0.0, "top_p": 0.1}
    )
...
async def run_twitter_simulation(
    ...
    for round_num in range(total_rounds):
        ...
        # [CRITIC INJECTION] Audit actions strictly for medical coherence using CoT / JSON validation
        actual_actions = filter_actions_with_critic(actual_actions, db_path)
