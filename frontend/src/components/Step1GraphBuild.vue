    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Extracts seeds to automatically generate clinical ontology.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Builds the knowledge graph extracting entities, relationships, memories.
          </p>
          ...
          <div class="stats-grid">
            <div class="stat-card">
              ...
              <span class="stat-label">Subject Nodes</span>
            </div>
            <div class="stat-card">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">GraphRAG BuildComplete，Please proceed to next step进行模拟Environment Setup</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? 'Creating...' : 'Enter Setup ➝' }}
          </button>
        </div>
      </div>
    </div>
...
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      console.error('Simulation create failed:', res.error)
      alert('Simulation create failed: ' + (res.error || 'UnknownError'))
    }
  } catch (err) {
